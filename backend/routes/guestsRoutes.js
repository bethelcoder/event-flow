...
const { MarkGuestAnnouncementRead,registerGuest, guestAccess, guestReport } = require('../controllers/guestsController');
...
router.post('/access/:guestId/announcements/read',MarkGuestAnnouncementRead);
